...
collection_csv = os.path.join('..','assignment_project_1','holiday_set.csv')
...
item_metadata_directory = os.path.join('..','assignment_project_1','holiday_item_metadata')
...
item_metadata_directory = 'holiday_item_metadata'
item_metadata_file_prefix = 'holiday_item_metadata'
json_suffix = '.json'
...
files_dir = 'holiday_item-files'
metadata_dir = 'holiday_item_metadata'
